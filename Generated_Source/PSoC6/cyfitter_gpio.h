...
/* BUTTON_PIN */
#define BUTTON_PIN_0_DRIVEMODE CY_GPIO_DM_HIGHZ
#define BUTTON_PIN_0_INBUF_ENABLED 1u
#define BUTTON_PIN_0_INIT_DRIVESTATE 0u
#define BUTTON_PIN_0_INIT_MUXSEL 0u
#define BUTTON_PIN_0_INPUT_SYNC 2u
#define BUTTON_PIN_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define BUTTON_PIN_0_NUM 4u
#define BUTTON_PIN_0_PORT GPIO_PRT0
#define BUTTON_PIN_0_SLEWRATE CY_GPIO_SLEW_FAST
#define BUTTON_PIN_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define BUTTON_PIN_DRIVEMODE CY_GPIO_DM_HIGHZ
#define BUTTON_PIN_INBUF_ENABLED 1u
#define BUTTON_PIN_INIT_DRIVESTATE 0u
#define BUTTON_PIN_INIT_MUXSEL 0u
#define BUTTON_PIN_INPUT_SYNC 2u
#define BUTTON_PIN_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define BUTTON_PIN_NUM 4u
#define BUTTON_PIN_PORT GPIO_PRT0
#define BUTTON_PIN_SLEWRATE CY_GPIO_SLEW_FAST
#define BUTTON_PIN_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
